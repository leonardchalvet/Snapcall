<html>
	...
	<body>
				...
				<div class="wrapper">
					<div class="container-text sectionAnim_container">
						...
						<p class="elAnim__slide anim__delayMedium_1">
							Allow your customers to call you from the page they are already visiting. Enhance their digital journeys and make them personal.
						</p>
					</div>
					<div class="container-el">
						<div class="el sectionAnim_container">
							...
							<div class="container-illu elAnim__fade anim__delayMedium_3">
								<iframe src="https://player.vimeo.com/video/337951306?api=1&loop=1&background=1&mute=0&quality=540p" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
							</div>
						</div>
						...
						<div class="el sectionAnim_container">
							...
							<div class="container-illu elAnim__fade anim__delayMedium_3">
								<img class="illu-size-1" src="img/product/section-features/web-call-illu-3.png" alt="">
							</div>
						</div>
					</div>
				</div>
							...
							<div class="content">
								...
								<div class="container-pr">
									...
									<div class="text">
										...
										<q class="wrapLine">
											SnapCall facilitates for customers outside Europe to reach us. <i>Initiating a call</i> is as <i>easy</i> and effortless as initiating a chat.
										</q>
									</div>
								</div>
		...
		<script type="text/javascript">var snapcall_script=document.createElement("script");snapcall_script.setAttribute("class","snapcall");snapcall_script.setAttribute("btn-bid","93b7efa490dd11e9ade40ae222c5da84");snapcall_script.src="https://snap.snapcall.io/snapapp.min.js";document.body.appendChild(snapcall_script);</script>
	</body>
</html>
