<html>
	<head>
		...
		<title>Product - Smart Plugs</title>
	...
	<body>
				...
				<div class="wrapper">
					<div class="container-text">
						...
						<h1 class="elAnim__slide anim__delayMedium_1">
							Versatile and smartly connected.
						</h1>
					</div>
		...
		<script type="text/javascript">var snapcall_script=document.createElement("script");snapcall_script.setAttribute("class","snapcall");snapcall_script.setAttribute("btn-bid","9d90fa5490de11e9ade40ae222c5da84");snapcall_script.src="https://snap.snapcall.io/snapapp.min.js";document.body.appendChild(snapcall_script);</script>
	</body>
</html>
